...
:anguished: Have you ever been raided and were so caught up in something that you completely forgot to shout them out?<br>
With the simple streamerbot set up below you'll never miss a shout out again!
<br><br>
...
### Step 3: [Optional] Increase the Complexity

Want to have a different reception to the raiders based on how many people are raiding in?
<br>
You can easily set this up by adjusting the triggers and creating new actions!
<br>
To keep things simple we'll set up 2 different raid actions.  (Of course if you want to create more you can! The limit is your imagination :rainbow:)
