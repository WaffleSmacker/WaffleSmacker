...
<br><br>
1. Make sure "Enable WebSocket Server" is enabled.<br>
2. Note to make sure the Server Port is "4455" and that "Enable Authentication" is unchecked.<br>
3. Hit Ok!<br>
![image](https://github.com/WaffleSmacker/WaffleSmacker/assets/131427794/c0426d28-d5d8-485e-9bb5-0c85943c8d63)

### Connect StreamerBot

1. Open Streamerbot and head to the "Stream Apps" tab.

2. Click the "OBS" tab.<br>
![image](https://github.com/WaffleSmacker/WaffleSmacker/assets/131427794/a786a001-43bd-4e8d-8743-b55d62a66848)
<br><br>

4. Right click on an empty space and click "Add" <br>
...
![image](https://github.com/WaffleSmacker/WaffleSmacker/assets/131427794/3b9b2fcd-dac8-4426-9852-5cf0dbf126a6) <br> <br>
